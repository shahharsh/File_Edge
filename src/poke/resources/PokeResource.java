...
public class PokeResource implements Resource {
	...
	public Response process(Request request)  {
		...
		// Code to Save file.
		/*byte[] chunkDataFromFile = request.getBody().getDoc().getChunkContent().toByteArray();
		FileOutputStream fileOuputStream = null;
		try {
			fileOuputStream = new FileOutputStream(request.getBody().getDoc().getDocName(),false);
		...
		System.out.println("-----------------------------------------------------------------------------");
		System.out.println("File save operation is completed.");
		System.out.println("-----------------------------------------------------------------------------");*/
